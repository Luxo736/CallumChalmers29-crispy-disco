...
def test_find_snp_in_database():
	assert find_snp('11', '73150080', 'IMR90rep2-DNAse-hypersensitivity-GSM468801.wig') == "131"

def test_find_snp_in_database1():
	assert find_snp("11", "73150005", 'IMR90rep2-DNAse-hypersensitivity-GSM468801.wig') == "153"
